...
func TestEqual(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{0.000000001, 0.000000011, false},
		{0.000000001, 0.000000001, true},
		{0.000000001, 0.0000000011, true},
		{complex(0.000000001, 1), complex(0.000000011, 1), false},
		{complex(0.000000001, 1), complex(0.000000001, 1), true},
		{complex(0.000000001, 1), complex(0.0000000011, 1), true},
	} {
